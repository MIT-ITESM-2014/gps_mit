				    ...
				    if(Yii::app()->user->getState('isAdmin') == 1)
				    {
				      $this->widget('zii.widgets.CMenu',array(
					      ...
					      'items'=>array(
						      ...
						      array('label'=>'<div id="fleet-image"> </div> <div class="mainmenu-titles"> Fleets </div>', 'url'=>array('/company/admin')),
					      ), 'id' => 'menu-elements' 
				      ));
				    }
				    elseif(Yii::app()->user->getState('companies_count') > 0)
				    {
				      $this->widget('zii.widgets.CMenu',array(
					      ...
					      'items'=>array(
						      ...
						      array('label'=>'<div id="change-parameters-image"> </div>  <div class="mainmenu-titles"> Change Parameters </div>', 'url'=>array('/parameterForm/update')),
