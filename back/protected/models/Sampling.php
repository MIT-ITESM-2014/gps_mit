...
/**
 * This is the model class for table "sampling".
 *
 * The followings are the available columns in table 'sampling':
 * @property integer $id
 ...
 */
class Sampling extends CActiveRecord
{
	/**
	 ...
	 * @return Sampling the static model class
	 */
